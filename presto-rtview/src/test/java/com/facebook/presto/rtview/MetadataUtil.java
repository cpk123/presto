...
public final class MetadataUtil
{
    ...
    public static final JsonCodec<Map<String, List<RtviewTable>>> CATALOG_CODEC;
    public static final JsonCodec<RtviewTable> TABLE_CODEC;
    public static final JsonCodec<RtviewColumnHandle> COLUMN_CODEC;
    ...
    static {
        ...
        CATALOG_CODEC = codecFactory.mapJsonCodec(String.class, listJsonCodec(RtviewTable.class));
        TABLE_CODEC = codecFactory.jsonCodec(RtviewTable.class);
        COLUMN_CODEC = codecFactory.jsonCodec(RtviewColumnHandle.class);
    }
