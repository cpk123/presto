...
public class TestRtviewRecordSet
{
    ...
    public void testGetColumnTypes()
            throws Exception
    {
        RecordSet recordSet = new RtviewRecordSet(new RtviewSplit("test", "schema", "table", dataUri), ImmutableList.of(
        ...
        recordSet = new RtviewRecordSet(new RtviewSplit("test", "schema", "table", dataUri), ImmutableList.of(
                new RtviewColumnHandle("test", "value", BIGINT, 1),
                new RtviewColumnHandle("test", "text", createUnboundedVarcharType(), 0)));
